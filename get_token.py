...
def main():
    print("=== Aesthetic EN (GlobeGuess): Refresh Token 取得 ===")
    ...
    print("SUCCESS")
    print("="*50)
    print(f"\nYOUTUBE_CLIENT_ID_AESTHETIC_EN:\n{client_info.get('client_id')}\n")
    print(f"YOUTUBE_CLIENT_SECRET_AESTHETIC_EN:\n{client_info.get('client_secret')}\n")
    print(f"YOUTUBE_REFRESH_TOKEN_AESTHETIC_EN:\n{creds.refresh_token}\n")
    print("="*50)
